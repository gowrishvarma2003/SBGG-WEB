	...
	return (
		<div className="container mx-auto p-8 flex flex-col items-center mb-8">
			...
			>
				...
				machinery solutions, including oil packing <br />
				machines, namkeen packing machines, and a wide range of other
				packaging equipment. Our mission is to <br />
			...
			>
				{services.map((service, index) => (
					<div
						...
						className={`${hoveredIndex == index ? 'bg-[#4DBF38]' : 'bg-white'} p-6 shadow-lg text-left relative transform transition-transform duration-150 ease-in-out hover:scale-105 hover:shadow-2xl rounded-t-md`}
					>
						...
						<h2 className={`${hoveredIndex == index ? 'text-white' : 'text-black'} text-2xl font-semibold mb-2 pt-0`}>
							{service.title}
						</h2>
						<p
							className={`${hoveredIndex == index ? 'text-gray-200 opacity-90' : 'text-gray-700'}  pb-12`}
							style={{ width: "85%" }}
						>
							{service.description}
						</p>
